...
The configuration of a humanoid robot with $n$ joints depends on the robot shape, i.e., joint angles $\bf{s}\in \mathbb{R}^n$,

 the position $^{ I}\bf{p}_{ B}\in \mathbb{R}^3 $ 

, and orientation $ ^{ I}{\bf{R}}_{ B}\in SO(3)$ of the floating base (usually associated with the pelvis,
